...
using StuartsLateFeeCalculator;
...
namespace RentalItemMaintenance
{
    public static class RentalItemDB
    {
        ...
        public static List<RentalItem> GetRentalItems()
        {
            ...
            if (xmlIn.ReadToDescendant("RentalItem"))
            {
                ...
                do
                {
                    ...
                    rentalItem.StockNo =
                        (int) xmlIn.ReadElementContentAsDecimal();
        ...
        public static void SaveRentalItems(List<RentalItem> rentalItems)
        {
            ...
            // this line had to be changed to RentalItems's (added s for my code to work)
            // since in my .xml file the first tag is RentalItems and it was clashing with it's
            // sub tag RentalItem

            xmlOut.WriteStartElement("RentalItems");
