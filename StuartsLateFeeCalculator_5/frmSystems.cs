...
namespace StuartsLateFeeCalculator
{
    public partial class frmSystems : Form
    {
        ...
        private void btnAddLateGames_Click(object sender, EventArgs e)
        {
            ...
            // displaying the number of games returned back for this form
        ...
        private String calculateLateFee(double daysLate, double discount, int numOfGamesReturned)
        {
            ...
            discount = 5 * daysLate * numOfGamesReturned * discount;
            double lateFee = (5 * daysLate * numOfGamesReturned) - discount;
